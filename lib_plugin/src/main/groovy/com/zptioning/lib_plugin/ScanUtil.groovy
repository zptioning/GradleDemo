...
class ScanUtil {
    ...
    static final PROXY_CLASS_PACKAGE_NAME = "com/zptioning/gradledemo1"

    static final REGISTER_CLASS_FILE_NAME = "com/zptioning/lib_api/AppLifeCycleManager.class"

    //包含生命周期管理初始化类的文件，及包含 com.zptioning.lib_api.AppLifeCycleManager 类的class文件或者jar文件
